...
export default function SequenceEditor() {
  ...
  const addApiNode = (side, api, index, actorId) => {
    ...
    setNodes((nds) => [...nds, { id: `api-${Date.now()}`, type: 'apiNode', position: { x, y }, width: 28, height: 28, data: { label, side, method: api.method, url: api.url, actorId, actorName: actors[actorIdx]?.name || '', collapsed: true } }])
  }
