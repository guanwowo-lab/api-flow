  ...
  return (
    <div className="h-screen flex flex-col">
      ...
      <div className="flex-1 flex">
        {sidebarOpen && (
          <div ref={leftRef} className="w-48 bg-white border-r border-gray-200 p-3 overflow-y-auto shrink-0">
        ...
        {paletteOpen && (
          <div ref={rightRef} className="w-44 bg-white border-l border-gray-200 p-2 overflow-y-auto shrink-0 text-xs">
